...
export const REVIEW_ROOM_SCENES: Record<ActiveReviewRoomId, ReviewRoomScene> = {
  ...
  judgment: {
    reviewers: [
      { id: 'ai-06', labSlot: 'left-top', roomAssetId: 'room-06' },
      { id: 'ai-07', labSlot: 'left-middle', roomAssetId: 'room-07' },
      { id: 'ai-08', labSlot: 'left-bottom', roomAssetId: 'room-08' },
      { id: 'ai-09', labSlot: 'right-top', roomAssetId: 'room-09' },
      { id: 'ai-10', labSlot: 'right-middle', roomAssetId: 'room-10' },
    ],
    rooms: [
      { id: 'ai-06', reviewerId: 'ai-06', roomAssetId: 'room-06', layoutSlot: 'left-top' },
      { id: 'ai-07', reviewerId: 'ai-07', roomAssetId: 'room-07', layoutSlot: 'left-middle' },
      { id: 'ai-08', reviewerId: 'ai-08', roomAssetId: 'room-08', layoutSlot: 'left-bottom' },
      { id: 'ai-09', reviewerId: 'ai-09', roomAssetId: 'room-09', layoutSlot: 'right-top' },
      { id: 'ai-10', reviewerId: 'ai-10', roomAssetId: 'room-10', layoutSlot: 'right-middle' },
      { id: 'room-11', label: '', roomAssetId: 'room-11', layoutSlot: 'right-bottom' },
    ],
    tiles: {
